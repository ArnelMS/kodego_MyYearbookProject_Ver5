...
class DashboardsAdapter2(val studentModel: MutableList<Dashboards2>):RecyclerView.Adapter<DashboardsAdapter2.StudentViewHolder>(){

    inner class StudentViewHolder(var binding: RowItemStudentsBinding): RecyclerView.ViewHolder(binding.root)

    var onItemClick: ((Dashboards2) -> Unit)? = null
...
//            tvSection2.text = studentModel[position].maidenName
            ...
            holder.itemView.setOnClickListener() {
                onItemClick?.invoke(studentModel[position])
